                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: isOwner
                                  ? null
                                  : () async {
                                      // limit booking window to current + next month
                                      ...
                                      updated['rentedBy'] = currentUser;
                                      updated['status'] = 'pending';
                                      updated['rentedAt'] = DateTime.now()
                                          .toIso8601String();
                                      updated['rentedFrom'] = pickedRange.start
                                          .toIso8601String();
                                      updated['rentedTo'] = pickedRange.end
                                          .toIso8601String();
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Booking requested — Rs ${total.toStringAsFixed(2)} (Pending)',
                                          ),
                                        ),
                                      );
